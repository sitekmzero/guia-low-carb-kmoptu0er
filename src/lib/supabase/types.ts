  ...
  public: {
    Tables: {
      ...
      copywriter_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: 'copywriter_messages_session_id_fkey'
            columns: ['session_id']
            isOneToOne: false
            referencedRelation: 'copywriter_sessions'
      ...
      copywriter_sessions: {
        Row: {
          ...
          pauta_selecionada: Json | null
          pautas_propostas: Json | null
          publico: string | null
          referencias_arquivos: Json | null
